...
func TestClientChecksRedirectAddressWithoutRetry(t *testing.T) {
	...
	client := NewClient(ClientOptions{HTTPClient: &http.Client{Transport: base}})
	_, err := client.Sync(context.Background(), "http://8.8.8.8/repository", nil)
